"""
Django Base Settings for Eagles & Eaglets Platform

This file contains settings common to all environments.
Environment-specific settings are in local.py, production.py, and test.py
"""
...
ROOT_URLCONF = 'eaglesneagletsbackend.urls'
...
WSGI_APPLICATION = 'eaglesneagletsbackend.wsgi.application'
ASGI_APPLICATION = 'eaglesneagletsbackend.asgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.authentication.CookieJWTAuthentication',  # cookie-first, Authorization header fallback
    ],
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Eagles & Eaglets API',
    'DESCRIPTION': 'Mentorship and capacity-building digital platform API',
    'VERSION': '1.0.0',
